...
<div className='flex gap-[10px] items-center text-[24px] font-bold mt-[40px] text-black'>
    <span>Sign In to <span className="font-extrabold text-[28px] tracking-wide text-black font-sans ml-1">Lixagram</span></span>
</div>
...
<div className='md:w-[50%] h-full hidden lg:flex justify-center items-center bg-[#000000] flex-col gap-[10px] text-white text-[16px] font-semibold rounded-l-[30px] shadow-2xl shadow-black p-[20px]'>

<img src={lixagramLogo} alt="Lixagram" className='w-[75%] object-contain mb-2' />
<p >Not Just A Platform , It's A LIXAGRAM</p>
</div>
      </div>
    </div>
  )
